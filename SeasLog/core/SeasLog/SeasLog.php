...
namespace Module\SeasLog\core\SeasLog;
...
defined("SEASLOG_EMERGENCY") or define("SEASLOG_EMERGENCY", "emergency");
...
class SeasLog
{
     ...
     * @return bool
     */
    static public function setRequestID($reqid){
    	return TRUE;
    }
    /**
     * 获取本次请求标识
     ...
     * @return bool
     */
    static public function setServerIP($ip){
    	return TRUE;
    }
    /**
     * 获取当前服务器IP
     ...
     * @return bool
     */
    static public function setClientIP($ip){
    	return TRUE;
    }
    /**
     * 获取请求的客服端IP
